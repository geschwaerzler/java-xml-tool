...
/**
 * JPAReservierungId generated by hbm2java
 */
@Embeddable
public class JPAReservierungId  implements java.io.Serializable {
    ...
    public JPAReservierungId() {
    }

    public JPAReservierungId(String stadtcode, String stationsName, String reservierungsNr) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof JPAReservierungId) ) return false;
		 JPAReservierungId castOther = ( JPAReservierungId ) other; 
