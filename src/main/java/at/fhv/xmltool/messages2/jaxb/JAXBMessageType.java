...
/**
 * <p>Java-Klasse für message-type complex type.
 * 
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{http://xmllab.fhv.at/messages2}text"/&gt;
 *         &lt;element ref="{http://xmllab.fhv.at/messages2}in-reply-to" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class JAXBMessageType {

    @XmlElement(required = true)
    protected String text;
    @XmlElement(name = "in-reply-to")
    protected List<JAXBInReplyToType> inReplyTo;
     ...
     * {@link JAXBInReplyToType }
     * 
     * 
     */
    public List<JAXBInReplyToType> getInReplyTo() {
        if (inReplyTo == null) {
            inReplyTo = new ArrayList<JAXBInReplyToType>();
        }
